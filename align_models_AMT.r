...
input.dir    = paste(base.dir, '/asc/', sep ='')          # location of existing lineage distribution models
output.dir   = paste(base.dir, '/asc_aligned/', sep='')   # location to save aligned lineage distribution models
template_ext = paste('C:/Users/Chris/Desktop/PE/PE_paper_GLMs/generate_data_for_GLMs_NEW_NEW/asc/lin_model_phylogenetic_endemism35_clip.asc')   # an .asc grid with the extent to which all models will be cropped and aligned.
